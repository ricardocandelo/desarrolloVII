...
//Ejemplo de uso clase padre

$soporte1 = new Soporte("The soccer Game",22,3);
echo "<br> Precio: ". $soporte1->titulo."<br>"; 
echo "</br> precio ITBM incluido: ". $soporte1->dame_precio_sin_itbm()." dolares";
...
echo "<p>";$mijuego2 = new juego("Fifa 18", 27, 3, "PS 4",1,2);
